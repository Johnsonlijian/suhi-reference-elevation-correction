...
ax.scatter([zU],[LU],color=URB,s=70,zorder=5,ec='k',lw=0.5); ax.text(zU,LU+0.6,'urban U',color=URB,ha='center',fontsize=8.5)
...
ax.set_title('b  Elevation-mismatched reference biases SUHI = U − R',loc='left',fontsize=9.5)
